    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
                ...
                <nav class="navbar navbar-static-top">
                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-body">
                                        <div class="row">
                                            <div class="col-xs-4 text-center">
                                                <a href="<?= base_url() ?>public/#">Habilitar Colaborador</a>
                                            </div>
                                            <div class="col-xs-4 text-center">
                                                <a href="#"></a>
                                            </div>
                                            <div class="col-xs-4 text-center">
                                                <a href="<?= base_url() ?>public/#">Registrar Colaborador</a>
                                            </div>
                                        </div>
                                        <!-- /.row -->
                                    </li>
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="<?= base_url() ?>public/#" class="btn btn-default btn-flat">Perfil</a>
                                        </div>
                                        <div class="pull-right">
                                            <a href="<?= base_url() ?>public/#" class="btn btn-default btn-flat">Cerrar sesiòn</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <a href="<?= base_url() ?>public/#" data-toggle="control-sidebar"><i class="fa fa-gears"></i></a>
                            </li>
                        </ul>
                    </div>
                </nav>
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        ...
                        <div class="pull-left info">
                            ...
                            <a href="<?= base_url() ?>public/#"><i class="fa fa-circle text-success"></i> Online</a>
                        </div>
                    </div>
                    <!-- search form -->
                    ...
                    <ul class="sidebar-menu bg-green-active" data-widget="tree">
                        <li class="header">MAIN NAVIGATION</li>
                        <li class="active treeview">
                            <a href="<?= base_url() ?>public/#">
                                <i class="fa fa-briefcase"></i> <span>Categoria</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                            <ul class="treeview-menu">
                                <li class="active"><a href="<?= base_url() ?>public/index.html"><i class="fa fa-circle-o"></i> Nueva</a></li>
                                <li><a href="<?= base_url() ?>public/index2.html"><i class="fa fa-circle-o"></i> Listar</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="<?= base_url() ?>public/#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?= base_url() ?>public/pages/layout/top-nav.html"><i class="fa fa-circle-o"></i> Nuevo</a></li>
                                <li><a href="<?= base_url() ?>public/pages/layout/boxed.html"><i class="fa fa-circle-o"></i> Consultar</a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?= base_url() ?>public/pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> Crear</a></li>
                                <li><a href="<?= base_url() ?>public/pages/charts/morris.html"><i class="fa fa-circle-o"></i> Consultar</a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="treeview">
                                    <a href="<?= base_url() ?>public/#"><i class="fa fa-circle-o"></i> Orden Entrada
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </span>
                                    </a>
                                    <ul class="treeview-menu">
                                        <li><a href="<?= base_url() ?>public/#"><i class="fa fa-circle-o"></i> Registrar</a></li>
                                        <li class="treeview">
                                            <a href="<?= base_url() ?>public/#"><i class="fa fa-circle-o"></i> Consultar
                                ...
                                <li class="treeview">
                                    <a href="<?= base_url() ?>public/#"><i class="fa fa-circle-o"></i> Orden Salida
                                        <span class="pull-right-container">
                                            <i class="fa fa-angle-left pull-right"></i>
                                        </span>
                                    </a>
                                ...
                                <li><a href="<?= base_url() ?>public/pages/UI/icons.html"><i class="fa fa-circle-o"></i> Reportes</a></li>
                        ...
                        <li>
                            <a href="widgets.html">
                                <i class="fa fa-th"></i> <span>Restauraciòn</span>
                                <span class="pull-right-container">
                                    <small class="label pull-right bg-green">Datos</small>
                                </span>
                            </a>
                        </li>
            ...
            <div class="content-wrapper">
                <h1 class="label-primary">{heading}</h1>
                {contenido}
                {footer}
            </div>
            <!-- ./wrapper -->
